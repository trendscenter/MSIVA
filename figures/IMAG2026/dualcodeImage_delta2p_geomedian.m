...
v5d = load(['v',num2str(version),'/delta2p/delta2p_geomedian_sMRI_3d.mat']).v3d;
...
for ss = 1:14
    % for bin = 1:8
        ...
        exportgraphics(t,['/Users/xli77/Dropbox (GaTech)/MISA-pytorch/figures/SIVA/v',num2str(version),'/delta2p_geomedian_map/delta2p_geomedian_predictor',num2str(ss),'.png'],'BackgroundColor','w');%'_bin',num2str(bin),
        %--------------------------------------------------------------------------
        ...
        saveas(gcf,['/Users/xli77/Dropbox (GaTech)/MISA-pytorch/figures/SIVA/v',num2str(version),'/delta2p_geomedian_map/colorbar_delta2p_geomedian_predictor',num2str(ss),'.png']);%'_bin',num2str(bin),
