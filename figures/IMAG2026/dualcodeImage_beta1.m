...
%--------------------------------------------------------------------------
version = 5;
v4d = load(['v',num2str(version),'/delta2p/beta1_sMRI_3d.mat']).v3d;
...
%             hold on;
        ...
        exportgraphics(t,['/Users/xli77/Dropbox (GaTech)/MISA-pytorch/figures/SIVA/v',num2str(version),'/beta1_map/beta1_predictor',num2str(ss),'.png'],'BackgroundColor','w')
        %--------------------------------------------------------------------------
...
%         set(gcf,'Color',[0 0 0]); % RGB values [0 0 0] indicates black color
        ...
        saveas(gcf,['/Users/xli77/Dropbox (GaTech)/MISA-pytorch/figures/SIVA/v',num2str(version),'/beta1_map/colorbar_beta1_predictor',num2str(ss),'.png'])
